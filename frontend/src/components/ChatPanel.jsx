...
export default function ChatPanel({ busy, onRun }) {
  ...
  return <section id="incident" className="panel input-panel">
    ...
    <form onSubmit={submit}>
      <fieldset disabled={!!busy}>
        ...
        <div className="log-label"><label htmlFor="logs">Incident logs <span className="label-note">/ MESSAGE</span></label><button type="button" className="text-button" onClick={() => setLogs(SAMPLE)}>Load sample ↗</button></div>
